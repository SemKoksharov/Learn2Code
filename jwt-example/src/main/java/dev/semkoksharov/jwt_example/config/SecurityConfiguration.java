package dev.semkoksharov.jwt_example.config;

import dev.semkoksharov.jwt_example.authentication.AuthFilterJWT;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(registry -> {
                    registry.requestMatchers("/api/home/welcome/**", "/api/signup/**", "/api/home/login/**").permitAll();
